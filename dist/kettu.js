...
//# sourceURL=${plugin.id}`;
  ...
  var import_react6, import_react_native23, queryClient;
  ...
  var import_react7, import_react_native27, actionSheet2;
  ...
  function AssetDisplay({ asset }) {
    return /* @__PURE__ */ jsx(LegacyFormRow, {
      ...
      trailing: /* @__PURE__ */ jsx(import_react_native29.Image, {
        source: asset.id,
        style: {
          width: 32,
          height: 32
  ...
  var import_react_native31, import_react_native32, hideActionSheet3, showSimpleActionSheet4, AlertModal4, AlertActionButton4, openAlert3, RDT_EMBED_LINK, useStyles3;
