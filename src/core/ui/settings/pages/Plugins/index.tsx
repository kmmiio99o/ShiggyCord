...
export default function Plugins() {
  ...
  return (
    <PluginPage
      ...
      ListHeaderComponent={() => {
        const unproxiedPlugins = Object.values(VdPluginManager.plugins).filter(
          (p) =>
            !p.id.startsWith(VD_PROXY_PREFIX) &&
            !p.id.startsWith(BUNNY_PROXY_PREFIX),
        );
